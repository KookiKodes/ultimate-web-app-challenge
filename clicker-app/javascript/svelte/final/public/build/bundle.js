...
var app = (function () {
    ...
    const counter = ({ starting = 0, min = -Infinity, max = Infinity }) => {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button2.textContent = "+";
    			attr_dev(h1, "class", "svelte-itk6k1");
    			add_location(h1, file, 9, 2, 250);
    			attr_dev(button0, "class", "svelte-itk6k1");
    			add_location(button0, file, 11, 4, 299);
    			attr_dev(button1, "class", "svelte-itk6k1");
    			add_location(button1, file, 12, 4, 343);
    			attr_dev(button2, "class", "svelte-itk6k1");
    			add_location(button2, file, 13, 4, 387);
    			attr_dev(div, "class", "container svelte-itk6k1");
    			add_location(div, file, 10, 2, 271);
    			attr_dev(main, "class", "svelte-itk6k1");
    			add_location(main, file, 7, 0, 183);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button2, "click", /*increment*/ ctx[2], false, false, false)
    				];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let [number, { increment, decrement, reset }] = counter({});
    	validate_store(number, 'number');
    	component_subscribe($$self, number, value => $$invalidate(0, $number = value));
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('decrement' in $$props) $$invalidate(3, decrement = $$props.decrement);
    	...
    	return [$number, number, increment, decrement, reset];
    }
